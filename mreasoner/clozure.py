...
DL_URLS = {
    'Darwin': 'https://github.com/Clozure/ccl/releases/download/v1.12/ccl-1.12-darwinx86.tar.gz',
    'Windows': 'https://github.com/Clozure/ccl/releases/download/v1.12/ccl-1.12-windowsx86.zip',
    'Linux': 'https://github.com/Clozure/ccl/releases/download/v1.12/ccl-1.12-linuxx86.tar.gz'
}
...
class ClozureCL():
    ...
    def __init__(self, ccl_dir='.ccl'):
        ...
        self.ccl_path = None
        self.ccl_dir = os.path.normpath(self.ccl_dir + '/ccl')
